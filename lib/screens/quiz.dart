...
class _QuizState extends State<Quiz> {
  ...
  Widget multipleChoiceQuestionWithoutImage(
      QuizProvider quizProvider, width, height) {
                                      ...
                                      child: MathField(
                                        ...
                                        onChanged: (String text) {
                                          if (text == '') {
                                            ...
                                            quizProvider.editSubQuestionAnswer(
                                                question['id'],
                                                subQuestion['id'],
                                                r'$' + text + r'$');
                                          }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              const SizedBox(),
                              if (quizProvider.questions[quizProvider.questionIndex - 1]['type'] ==
                                      'multipleChoiceQuestion' &&
                                ...
                                finalAnswerQuestionWithoutImage(quizProvider, width, height)
                              else if (quizProvider.questions[quizProvider.questionIndex - 1]['type'] == 'finalAnswerQuestion' && quizProvider.questions[quizProvider.questionIndex - 1]['image'] != null)
                                finalAnswerQuestionWithImage(quizProvider, width, height)
                              else if (quizProvider.questions[quizProvider.questionIndex - 1]['type'] == 'multiSectionQuestion' && quizProvider.questions[quizProvider.questionIndex - 1]['image'] == null)
                                multiSectionQuestionWithoutImage(quizProvider, width, height)
                              else if (quizProvider.questions[quizProvider.questionIndex - 1]['type'] == 'multiSectionQuestion' && quizProvider.questions[quizProvider.questionIndex - 1]['image'] != null)
                                multiSectionQuestionWithImage(quizProvider, width, height),
                              Padding(
